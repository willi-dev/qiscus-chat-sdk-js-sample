...
define(['service/emitter', 'jquery'], function (emitter, $) {
	...
	// var appId = 'halodoc-stage'
	// var appId = 'squline-gbcsdnxbn3cz3'
	// var appId = 'qchatsdk--ezleu2nf2ht'
	...
	qiscus.init({
		...
		// Halodoc Prod
		// AppId: 'dinosauru-l88z1enpnz4',
		// mqttURL: 'wss://qiscus-mqtt.api.halodoc.com:1886/mqtt',
		// baseURL: 'https://qiscus-lb.api.halodoc.com',

		// Halodoc Stag
		mqttURL: 'wss://qiscus-mqtt.stage.halodoc.com:1886/mqtt',

		// SDK Staging
		// AppId: 'dragongo',
		// baseURL: 'https://dragongo.qiscus.com',
		// mqttURL: 'wss://realtime-sre.qiscus.com:1886/mqtt',

		// SDK Kube
		// AppId: 'sdksample',
		// baseURL: 'https://kubernetes-sdk-api.qiscus.com:9443',
		// mqttURL: 'wss://realtime-sre.qiscus.com:1886/mqtt',

		// SDK Halodoc test
		// mqttURL: 'wss://qiscus-mqtt-test.api.halodoc.com:1886/mqtt',
